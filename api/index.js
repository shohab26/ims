...
const stockTransferRoute = require('./routes/stock_transfers');
...
app.use('/returns',    verifyToken, checkPermission('returns'), returnsRoute);
app.use('/stock-transfers', verifyToken, checkPermission('stock_transfers'), stockTransferRoute);
app.use('/reports',   verifyToken, checkPermission('reports'), reportsRoute);
app.use('/dashboard', verifyToken, checkPermission('dashboard'), dashboardRoute);
